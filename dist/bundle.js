...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_templateEngine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/templateEngine */ "./src/js/templateEngine.ts");
/* harmony import */ var _js_screenPatterns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/screenPatterns */ "./src/js/screenPatterns.ts");
...
window.application = {
    screens: { renderDifficultyScreen: renderDifficultyScreen },
    difficultyLevel: '',
    cardsTotal: [],
    cardsOpened: [],
    cardsToCompare: [],
...
function renderDifficultyScreen() {
    ...
    var difficultySelectBox = document.querySelector('.difficulty_box');
    var button = document.querySelector('.difficulty_button');
    difficultySelectBox.addEventListener('click', function (event) {
...
function renderGame(difficulty, time) {
    ...
    var generatedCards = __spreadArray(__spreadArray([], cards, true), cards, true);
...
function hideCards(card, cardCover) {
    var hideCards = setInterval(function () {
        ...
        window.application.cardHideTimer.forEach(function (item) {
            clearInterval(item);
        });
    }, 5000);
}
...
function compareCards() {
    var card1 = window.application.cardsToCompare[0];
    var card2 = window.application.cardsToCompare[1];
    if (card1 === card2) {
...
function playerWin(cardsOpened) {
    ...
    var array2 = window.application.cardsTotal;
    var array1 = window.application.cardsOpened.flat();
...
function timeCount(time) {
    var timeBox = document.querySelector('.game__top-box_timer');
    timeBox.textContent = "".concat(time, ":00");
    var timeMinut = (time) * 60;
    var timer = setInterval(function () {
        var seconds = timeMinut % 60;
        var minutes = timeMinut / 60 % 60;
        var strTimer = "".concat(Math.trunc(minutes), ":").concat(seconds);
